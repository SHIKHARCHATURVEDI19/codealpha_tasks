...
const db = new sqlite3.Database(dbPath, (err) => {
    if (err) {
        ...
        db.serialize(() => {
            ...
            // Insert initial mock products if none exist
            db.get("SELECT COUNT(*) AS count FROM Products", (err, row) => {
                if (row.count === 0) {
                    ...
                    const mockProducts = [
                        ['Quantum Keyboard', 'A mechanical keyboard with quantum switches for zero latency.', 99.99, 129.99, 1, 'assets/Portable_ergonomic_mechanical_ke._2K_202607191442.jpeg', 50, 'hardware'],
                        ...
                        ['Stellar Smartwatch', 'Track your health and time with the latest stellar-core technology.', 199.99, 249.99, 1, 'assets/Smartwatch_showing_health_metrics_202607191442.jpeg', 100, 'wearables'],
                        ...
                        ['Classic Leather Smartwatch', 'Advanced fitness tracking smartwatch with a premium leather strap.', 199.99, null, 0, 'assets/Smartwatch_showing_health_metrics_202607191442.jpeg', 40, 'quantum'],
                        ['Cybertech Ergonomic Keyboard', 'Split ergonomic mechanical keyboard with customizable RGB backlighting.', 179.99, 199.99, 1, 'assets/Portable_ergonomic_mechanical_ke._2K_202607191442.jpeg', 20, 'quantum']
                    ];
